...
3 Ceramic Floor Tiles
 200x200mm      226~275  50
 300x300mm      276~330  55
 400x400mm      331~390  60
 450x450mm      391~460  70
 600x600mm      461~540  80
4 Border Tile& Decor Piece    541~630  90
...
public function id2cat($id) {
    ...
    {
        case 0:
            return  'Hot-Selling & New Products';
        break;
        case 1:
            return  '3D Inkjet Tile';
        break;
        case 2:
    ...
    public function readImageDirectory($directory) {
        ...
        if (!$galleryArray) {
            ...
            foreach ($dirArray as $key => $image) {
                ...
                $relativePath = 'single.php?n=' . str_replace('_', ' ', pathinfo($image['real_path'], PATHINFO_FILENAME));
    ...
    private function _arrayCat($array) {
            ...
            foreach ($array as $key => $image) {
                ...
                if (file_exists($iniPath))  {
                    ...
                    if (
                           ($ini['Catolog'] == $this->_cat  || '' == $this->_cat)
                        && ($ini['Size'] == $this->_size  || '' == $this->_size)
                        ){
